...
class KugelActivity: AppCompatActivity(), SensorEventListener {
    // sensor stuff
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_kugel)
        ...
        btnSettings.setOnClickListener {
            finish()
            val i = Intent(this@KugelActivity, ConfigActivity::class.java)
            startActivity(i)
        }
    ...
    override fun onResume() {
        ...
        loadState()
        sensorAccelerometer?.let { sensor ->
