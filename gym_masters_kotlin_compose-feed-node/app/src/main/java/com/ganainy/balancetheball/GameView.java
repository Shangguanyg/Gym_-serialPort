package com.ganainy.balancetheball;
...
public class GameView extends View
{
    ...
    public GameView(Context context, AttributeSet attrs)
    {
        ...
        mBallPaint.setColor(ContextCompat.getColor(context,R.color.black));
        ...
        mInPaint.setColor(ContextCompat.getColor(context,R.color.yellow));

        mFinishedPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        mFinishedPaint.setStyle(Paint.Style.FILL_AND_STROKE);
        mFinishedPaint.setColor(ContextCompat.getColor(context,R.color.green));
