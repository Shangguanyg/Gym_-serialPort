...
import com.ganainy.gymmasterscompose.databinding.ActivityPortMainBinding
import com.ganainy.serialportlibrary.Device
import com.ganainy.serialportlibrary.SimpleSerialPortManager
import com.ganainy.gymmasterscompose.R

class PortActivity : AppCompatActivity(){

    private val TAG = PortActivity::class.java.simpleName
    val DEVICE = "device"
    private var isSerialPortOpened = false
    private var mToast: Toast? = null
    private lateinit var binding: ActivityPortMainBinding


    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = DataBindingUtil.setContentView(this, R.layout.activity_port_main)
