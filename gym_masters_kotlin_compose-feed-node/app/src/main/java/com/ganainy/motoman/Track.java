...
import com.ganainy.motoman.track.TrackData;
import com.ganainy.motoman.track.TrackDirection;
import com.ganainy.motoman.track.TrackSegLine;
import com.ganainy.motoman.track.TrackSegLines;
...
//			buildingModel.render(shader);
	...
	public boolean getTrackCollisionVector(ITrackee trackee, Vector3 collisionPos, Vector3 collisionNor) {
		...
		if (collisionCount > 1) {
            collisionPos.scl(1f / collisionCount);
			collisionNor.nor();
			return true;
