...
public class GL20Debug implements GL20 {
    ...
    public void glDeleteTexture(int texture) {
        out.println("glDeleteTexture texture:" + texture);
...
//    @Override
//    public void glGetShaderSource(int shader, int bufsize, IntBuffer length, String source) {
