...
object SpecialChartComposer {
    ...
    val numberArr = arrayOfNulls<Any>(10000)
    ...
    fun configurePolarLineChart(): AAChartModel {
        Log.d("chart", "configurePolarLineChart")
...
//            y2 = cos(random * (i * Math.PI / 180)) + i * 3 * 0.01
            numberArr1[i] = y1 * 100
//            numberArr2[i] = y2
           // Log.d("chart", "numberArr1[i] is : ${numberArr1[i]}")
        }

        System.arraycopy(numberArr1,0,numberArr,updateTimes,maxRange)

        updateTimes += maxRange

        Log.d("chart", "numberArr is : ${numberArr}")
        Log.d("chart", "updateTimes is : ${updateTimes}")
